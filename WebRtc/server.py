...
#         video = cv2.VideoCapture("rtsp://admin:Admin1234@183.82.105.11/cam/realmonitor?channel=1&subtype=00&authbasic=YWRtaW46QWRtaW4xMjMh")
...
async def offer(request):
    ...
    def on_track(track):
        ...
        if track.kind == "audio":
            pc.addTrack(player_audio.audio)
            recorder.addTrack(track)
        elif track.kind == "video":
            pc.addTrack(player_video.video)
            recorder.addTrack(track)
        # elif track.kind == "video":
